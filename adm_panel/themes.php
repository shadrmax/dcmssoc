...
if (test_file(H.'style/themes/'.$themes.'/screen_48.png'))
...
echo (test_file(H.'style/themes/'.$themes.'/style.css'))?"<a href='/style/themes/$themes/style.css'>style.css</a>: ".size_file(filesize(H.'style/themes/'.$themes.'/style.css'))."<br />\n":"Нет style.css<br />\n";
