...
if ((user_access('foto_foto_edit')) || (isset($user) && $ank['id'] == $user['id']))
 include_once check_replace( 'inc/gallery_show_foto_act.php');
...
if (isset($_POST['msg']) && isset($user))
{
  ...
  $mat = antimat($msg);
    ...
    include_once check_replace('sys/add/user.active.php');
...
include_once check_replace(H.'sys/add/user.privace.php');
