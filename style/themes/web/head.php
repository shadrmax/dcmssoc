...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <head>
        ...
        <link rel="shortcut icon" href="/favicon.ico" /><link rel="stylesheet" href="/style/themes/<? echo $set['set_them']; ?>/style.css?v2" type="text/css" />
        <link rel="stylesheet" href="/style/themes/<? echo $set['set_them']; ?>/tables.css?v2" type="text/css" />
