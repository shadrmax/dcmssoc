...
{
	echo '<div class="foot">';
	echo '<img src="/style/icons/lj.gif" alt="*"> <a href="/forum/' . $forum['id'] . '/' . $razdel['id'] . '/?act=new" title="Создать новую тему">Новая тема</a><br />';
	echo '</div>';
}
...
{
	echo '<div class="mess">';
	echo 'Нет тем в разделе <b>' . text($razdel['name']) . '</b>';
	echo '</div>';
}	
