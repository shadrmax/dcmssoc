...
mysql_query("INSERT INTO `user` (`nick`, `pass`, `time_reg`, `date_reg`, `date_aut`, `date_last`, `pol`, `level`, `group_access`, `balls`, `money`)
VALUES('$nick', '".shif($password)."', $time,  $time, $time, $time, '$pol', '4', '15', '5000', '500')");
