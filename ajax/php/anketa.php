...
if (isset($_GET['id'])) {
  ...
  echo ' <a onclick="anketaClose.submit()" name="myForm"><div class="form_info">Скрыть подробную информацию</div></a>';/*=====================================Анкета пользователя, если авторто выводим ссылки на редактированиеполей, если нет то нет =)=====================================*/
