<?php
  ...
  function privAdd($p_filedescr_list, &$p_result_list, &$p_options)
  {
    $v_result=1;
    $v_list_detail = array();
    if ((!test_file($this->zipname)) || (filesize($this->zipname) == 0))
    {
  ...
  {
    $v_result=1;
    if (!test_file($p_archive_to_add->zipname))
    {
      $v_result = 1;
      return $v_result;
    }
  ...
  {
    $v_result=1;
    if (!test_file($p_archive_filename))
    {
      $v_result = 1;
      return $v_result;
    }
