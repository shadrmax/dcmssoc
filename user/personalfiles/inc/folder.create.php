...
echo 'Имя папки:<br/><input type="text" name="name" maxlength="30" value="" /><br />';
	...
	if ($set['web'] && test_file(H.'style/themes/'.$set['set_them'].'/altername_post_form.php'))		include_once H.'style/themes/'.$set['set_them'].'/altername_post_form.php';	else	{		echo $tPanel . '<textarea name="msg"></textarea><br />';	}
